...
<head>
    ...
    <script src="<%= request.getContextPath() %>/Script/Home/HomePopUp.js"></script>
...
<header class="header" id="header">
    <nav class="nav_header">
        ...
        <a href="/toyhouse_war/" class="logo">
        ...
        <div class="itens_nav">
            <nav class="menu">
                ...
                <a href="#" class="menu-item blue"> <img src="<%= request.getContextPath() %>/Images/Home/IconPerfil.webp" height="65px" width="65px"  alt=""> <i class="fa fa-anchor"></i> </a>
                <a href="#" class="menu-item green"> <img src="<%= request.getContextPath() %>/Images/Home/IconBuy.png" height="65px" width="65px" alt="">  <i class="fa fa-coffee"></i> </a>
                <a href="#" class="menu-item red"> <img src="<%= request.getContextPath() %>/Images/Home/IconConfig.png" height="65px" width="65px" alt=""> <i class="fa fa-heart"></i> </a>
                <a class="menu-item purple" onclick="showPopup()"> <img src="<%= request.getContextPath() %>/Images/Home/IconEntrar.webp"  height="65px" width="65px" alt="">  <i class="fa fa-microphone"></i> </a>
